...
export function PinPad({ onComplete, isLoading, error }: PinPadProps) {
    ...
    // Empêcher le scroll de la page lorsque le PinPad est affiché
    useEffect(() => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="w-full max-w-md flex flex-col items-center space-y-6 sm:space-y-8 md:space-y-10">
                {/* PIN Display - Dots */}
